...
1. Check if the bug has already been reported in [GitHub Issues](https://github.com/codemasklab/codemask-oss/issues)
...
- Open a [GitHub Discussion](https://github.com/codemasklab/codemask-oss/discussions)
